...
const Chat = () => {
  ...
  return (
    <div className="h-screen bg-gray-900 text-white p-4 flex flex-col items-center">
      <div className='fixed text-md text-white h-[30vh] w-[25vw] bg-[#1E2939] left-9 rounded-md  flex items-center justify-center'>
        <h1 className='p-4'>{ai}</h1>
      </div>
      <div className="w-full max-w-md flex flex-col flex-grow border border-gray-700 rounded-lg overflow-hidden">
